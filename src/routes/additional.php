...
use App\Http\Controllers\{Core\Auth\Role\PermissionController,
    ...
    Tenant\Project\ProjectController,
    Tenant\Project\ProjectUserController};
...
Route::get('project/activity-log', [ActivityLogController::class, 'show'])
    ->name('activity-log.show');

Route::get('user/activities/{user}', [ActivityLogController::class, 'activities'])
    ->name('user.activities');
Route::get('user/alerts/{user}', [ActivityLogController::class, 'alerts'])
    ->name('user.activities');

Route::get('project/activities/{project}', [ActivityLogController::class, 'ProjectActivities'])
    ->name('user.activities');
