    ...
    <div class="container-scroller">
        ...
        @section('side-bar')
            <sidebar :data="{{ json_encode($permissions)  }}"
                     logo-src="/images/PME-white-Logo.svg"
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            @if(env('IS_DEMO', false))
                <div class="" style="z-index:201; bottom:0; right:0; position:fixed; margin:50px;">
                    <a href="https://vt-lb.com" class="btn btn-warning rounded-pill shadow-lg">
                        <span class="mr-2"><app-icon name="shopping-cart"/></span>Get it now!
                    </a>
                </div>
            @endif
    </div>
