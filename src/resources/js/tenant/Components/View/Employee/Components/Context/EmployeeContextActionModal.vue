<template>
    <modal
        ...
        <form
            ...
            />
            <app-note v-if="modalType === 'clear_project'"
                      class="mb-4"
                      :title="$t('note')"
                      :notes="$t('all_selected_employees_assigned_to_project_will_be_cleared')"
            />
    ...
    methods: {
        submit() {
            ...
            if (actionType === 'joining-date') {
                ...
                this.updateEmployees(actionType)
            } else if (actionType === 'clear-project') {
                this.clearProjects(actionType)
            }
        },
