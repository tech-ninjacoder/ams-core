            ...
            <div class="actions" :class="{'loading-opacity': loading}">
                ...
                <template v-else>
                    <app-context-button
                        ...
                        <a href="#" class="dropdown-item" @click="openActionModal('clear_project')">
                            {{ this.$t('clear_project') }}
                        </a>
                    </app-context-button>
                    ...
                    <app-context-button
                            :class="{'loading-opacity': loading}"
                            :keep-open="true"
                            :title="this.$t('change_project')"
                            dropdown-menu-class="dropdown-menu-with-search"
                            icon="fast-forward">

                        <app-project-list-dropdown
                                v-model="formData.project_id"
                                :url="apiUrl.SELECTABLE_ACTIVE_PROJECT"
                                :title="$t('change_project')"
                                @filteredFlag="projectFlag = $event"
                        />
                        <template v-if="formData.project_id && projectFlag">
                            <div class="dropdown-divider my-0"/>
                            <div class="p-3 text-right">
                                <app-submit-button
                                        :label="$t('apply')"
