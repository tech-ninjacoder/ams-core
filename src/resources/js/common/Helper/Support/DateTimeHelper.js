...
export const dateTimeToUTCWithFormat = (date = null) => {
    if (!date) {
        return '';
    }
...
export const onlyTimeUAE = date => {
    return moment(date, serverDateTimeFormat)
        .local()
        .format(time_format());
};
...
export const formatDateTimeForServer = (dateTime = null) => {
    ...
    console.log('formatDateTimeForServer')
    return moment(dateTime, `${formatted_date()} ${time_format()}`).utc().format(serverDateTimeFormat)
}

export const formatDateTimeForUAE = (dateTime = null) => {
    if (!dateTime) {
        return '';
    }
    return moment(dateTime, `${formatted_date()} ${time_format()}`).utc().format(serverDateTimeFormat)
