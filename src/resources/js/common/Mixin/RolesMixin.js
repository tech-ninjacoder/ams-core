                    ...
                    this.$can('update_roles') ?
                        {
                            ...
                            modifier: (id, role) => {
                                return (role.is_default && role.is_admin) ? false :
                                    ...
                                    (role.alias === 'employee') ? this.$t('view') : this.$t('manage')
                ...
                actions: [
                    {
                        ...
                        url: '',
                        name: 'edit',
                        modifier: role => this.$can('update_roles') && !(role.is_default && role.is_admin) && !['manager', 'employee', 'department_manager', 'project_engineer','coordinator'].includes(role.alias)
                    },
                    {
                        title: this.$t('delete'),
                        icon: 'trash',
                        ...
                        url: '',
                        name: 'delete',
                        modifier: role => this.$can('delete_roles') && !(role.is_default && role.is_admin) && !['manager', 'employee', 'department_manager', 'project_engineer','coordinator'].includes(role.alias)
                    },
                    {
