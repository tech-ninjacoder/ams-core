        ...
        return {
            options: {
                ...
                actions: [
                    ...
                    {
                        title: this.$t('add_to_guardians_list'),
                        type: 'none',
                        name: 'add_to_guardians',
                        modifier: row => (!parseInt(row.is_guardian) && this.$can('update_users'))
                    },
                    {
                        title: this.$t('remove_from_guardians_list'),
                        type: 'none',
                        name: 'remove_from_guardians',
                        modifier: row => (parseInt(row.is_guardian) && this.$can('update_users'))
                    }
                ],
            },
