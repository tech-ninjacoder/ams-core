...
use Database\Seeders\Auth\AmsPermissionsRolesSeeder;
use Database\Seeders\Auth\AssignAllPermissionsToRoleSeeder;
...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        activity()->withoutLogs(function () {
            ...
            $this->call(AmsPermissionsRolesSeeder::class);//boudgeau
//            $this->call(AssignAllPermissionsToRoleSeeder::class);//boudgeau removed, will cause problem
