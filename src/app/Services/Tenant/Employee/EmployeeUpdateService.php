...
class EmployeeUpdateService extends EmployeeService
{
    protected array $ApprovedMethods = [
        ...
        'provider' => 'assignToProvider',
        'helmet' => 'assignToHelmet',
        'skills' => 'assignToSkill',
        'roles' => 'assignToRoles',
        'project' => 'assignToUsers',
    ...
    protected array $permissions = [
        ...
        'provider' => 'update_employees',
        'helmet' => 'update_employees',
        'skills' => 'update_employees',
        'project' => 'update_employees',
