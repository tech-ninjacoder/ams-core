...
class UserService extends BaseService
{
    ...
    {
        $roles = $this->checkMakeArray(request('skills'));
        $this->model->skills()->sync(array_unique($roles));
        return $this->model;
    }
    public function attachGatePass()
    {
        $roles = $this->checkMakeArray(request('gate_passes'));
        $this->model->gatePasses()->sync(array_unique($roles));
        return $this->model;
    }
