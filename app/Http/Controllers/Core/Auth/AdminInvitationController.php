...
use App\Services\Core\Auth\AdminInvitationService;
...
class AdminInvitationController extends Controller
{
    ...
    public function __construct(AdminInvitationService $service, BeforeUserInvited $beforeInvited, AfterUserInvited $afterInvited)
    {
