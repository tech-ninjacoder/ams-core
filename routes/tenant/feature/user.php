...
Route::patch('users/{user}/add-to-guardians', [UserEmployeeController::class, 'addToGuardians'])
    ->name('employees.add-user-to');

Route::patch('users/{user}/remove-from-guardians', [UserEmployeeController::class, 'removeFromGuardians'])
    ->name('employees.remove-user-from');
