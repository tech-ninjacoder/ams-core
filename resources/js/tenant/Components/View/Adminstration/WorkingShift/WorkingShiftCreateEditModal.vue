<template>
    <modal id="working-shift-modal"
        ...
        <form :data-url='selectedUrl ? selectedUrl : apiUrl.WORKING_SHIFTS'
          ...
          <div class="form-group d-flex flex-column flex-md-row align-items-md-center my-primary">
            <label class="mr-md-3 mb-md-0" v-if="checkDisable">{{ $fieldTitle('base', '') }}</label>
            <label class="mr-md-3 mb-md-0" v-else>{{ $fieldTitle('choose_a_base_time', '') }}</label>
            <div>
              <app-input
                  type="select"
                  :list="[
                  ...
                  :error-message="$errorMessage(errors, 'base')"
              />
            ...
            <div class="form-group d-flex flex-column flex-md-row align-items-md-center my-primary">
                <label class="mr-md-3 mb-md-0" v-if="checkDisable">{{ $fieldTitle('lunch_break', '') }}</label>
                <label class="mr-md-3 mb-md-0" v-else>{{ $fieldTitle('choose_a_lunch_break', '') }}</label>
                <div>
                    <app-input
                            type="select"
                            :list="[
                            ...
                            v-model="formData.lunch_break"
                            :error-message="$errorMessage(errors, 'lunch_break')"
                    />
