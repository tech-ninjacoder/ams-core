...
Vue.component("app-release-confirmation-modal", require('./components/release-confirmation-modal/Index').default);
Vue.component("app-project-release-confirmation-modal", require('./components/release-confirmation-modal/ProjectParentRelease').default);
