...
export const TableMixin = {
    ...
    computed: {
        ...
        showPaginationOptions() {
            return this.options.paginationOptions ? this.options.paginationOptions : [10, 50, 100, 200]
        },
        paginationClass() {
        ...
        ${this.totalRow}
        ${this.absence ? `
            ${this.$t(' || Absences:')} ${this.absence}
            ${this.$t(' || Assigned:')} ${this.assigned}
        ` : ''}
    `;
        },
        ...
        requestParams() {
            return this.isUndefined(this.options.queryParams) || this.options.queryParams
        }
    },
    methods: {
        /**
