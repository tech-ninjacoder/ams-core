...
Vue.component('wizard-modal', require('./Components/Helper/WizardModal').default)

Vue.component('modal-full-width', require('./Components/Helper/ModalFullWidth').default)
...
Vue.component('app-project-list-dropdown', require('./Components/Helper/ProjectListDropdown').default)
...
Vue.component('app-add-admin-modal', require('./Components/UserRole/UI/AdminAddEditModal').default);
...
Vue.component('app-employee-alerts', require('./Components/Auth/Profile/Alerts').default)
