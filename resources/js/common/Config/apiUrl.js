...
export const TENANT_SELECTABLE_CONTRACTOR = `${TENANT_BASE_URL}selectable/contractors`;
export const TENANT_SELECTABLE_LOCATION = `${TENANT_BASE_URL}selectable/locations`;
export const TENANT_SELECTABLE_SUBDIVISION = `${TENANT_BASE_URL}selectable/subdivisions`;
...
export const TENANT_SELECTABLE_PROJECT_STATUS = `${TENANT_BASE_URL}selectable/project-statuses`;
...
export const TENANT_SELECTABLE_FILTER_SKILLS = `${TENANT_BASE_URL}selectable/skills`;
export const TENANT_SELECTABLE_FILTER_GATE_PASS = `${TENANT_BASE_URL}selectable/gate_passes`;
