...
return array_merge([
    ...
    'sync_response' => ':name has been synced successfully',
    ...
    'access_all_departments'=> 'Can access all camps',
    'access_own_departments'=> 'Can access own camps',
    ...
    'update_departments_status' => 'Can update Camp status',
    ...
    'view_all_departments_holidays' => 'Can view all Camp holidays',
    ...
    'move_department_employees' => 'Can move Camp employees',
    'view_department_user' => 'Can view Camp users',
    ...
    'print_labor_distribution' => 'Print Labor Distribution',
    ...
    "this_content_will_be_release_permanently" => "This imei will be released permanently.",
    ...
    'projects' => 'Projects',
    'departments' => 'Camps',
    'workers_providers'=>'Workers Providers',
    ...
    // Department
    'create_departments' => 'Can create Camps',
    'view_departments' => 'Can view Camps',
    'update_departments' => 'Can update Camps',
    'delete_departments' => 'Can delete Camps',
    'attach_users_to_roles' => 'Can attach users to role',
    'parent_department' => 'Parent Camp',
    'location' => 'Location',
    'locations' => 'Locations',
    'description' => 'Description',
    'no_of_user' => 'No. of Employees',
    'remember_me' => 'Remember me',
    'parent_already_exists_warning' => 'Most parent Camp already exist. If you want to add new Camp you have to add it under a Camp.',
    'move_response' => ':subject moved to :location successfully',
    'manager_role_not_found' => 'Manager role not found',
    'number' => 'Number',
    'cant_add_child_department_as_parent_department' => 'You can\'t add child Camp as parent Camp',
    ...
    'you_can_set_the_holiday_only_for_specific_department_by_adding_them' => 'You can set the holiday only for specific Camp by adding them.',
    ...
    'assign_gate_pass' => 'Assign GatePass',
    ...
    'user_added_to_guardians' => 'User has been added to guardians list successfully.',
    'user_removed_from_guardians' => 'User has been removed from guardians list successfully',
    ...
    'all_selected_employees_assigned_to_project_will_be_cleared' => 'All selected employee assigned to a project will be cleared!',
    ...
    "move" => "Move",
    "department_manager_role_note" => "Want to disallow the employee for “Camp Manger” responsibility? Then please {edit} the Camp of the employee and assign another user.",

    // Employee
    'employees' => 'Employees',
    'add_department' => 'Add Camp',
    'department_name' => 'Camp name',
    ...
    'no_employees_warning' => 'No employees found in this Camp',
    'available_departments' => 'Available Camp',
    'do_you_want_to_move_employee' => 'Do you want to move employee?',
    'you_are_going_to_deactivate_a_department' => 'You are going to deactivate a Camp.',
    'you_are_going_to_activate_a_department' => 'You are going to activate a Camp.',
    'remove_from_employee_list' => 'Remove from employee list',
    'add_to_employee_list' => 'Add to employee list',
    'add_to_guardians_list' => 'Add to guardians list',
    'remove_from_guardians_list' => 'Remove from guardians list',


    'present' => 'Present',
    'not_yet_added' => 'Not yet added',
    'you_are_going_to_change_the_department_of_selected_employees' => 'You are going to change the Camp of selected employees!',
    'you_are_going_to_change_the_work_shift_of_selected_employees' => 'You are going to change the project / work shift of selected employees!',
    ...
    'enabled_recurring_attendance_suggestion' => 'Enabled',
    'disabled_recurring_attendance_suggestion' => 'Disabled',
    'recurring_attendance_suggestion' => 'In the enabled state, recurring attendance will be created for an employee if they are assigned to a project and do not have a helmet, In the disabled state, none helmet connected employee attendance must be entered manually.',
    ...
    'change_department' => 'Change Camp',
    'change_project' => 'Change Project',
    'choose_a_lunch_break' =>'Lunch Break',
    ...
    'multi_level_leave_approval_note' => 'Need multi approval by Camp manager based on Camp hierarchy or single approval by Manager/App admin.',
    'single_level_leave_approval_note' => 'Only one approval needed by any Camp manager to admin user.',
    ...
    'cant_delete_helmet' => 'Can not delete! Helmet has active users.',
    'cant_delete_gate_pass' => 'Can not delete! GatePass has active users.',
    'cant_delete_provider' => 'Can not delete! Provider has active users.',
    'cant_delete_skill' => 'Can not delete! Skill has active users.',
    ...
    'department_preference' => 'Camp preference',
    ...
    'manual_payrun_audience_message' => 'You can add users by Camp or Employee directly to generate payslip.
     if you select any Camp then it takes only active employees from that Camp. if you need to select inactive or terminated employees, you can select from by user filed',
    ...
    'selecting_restricted_user_will_prevent_execute_payrun_for_selected_employee_or_department_while_executing_default_payrun' => 'Selecting restricted user will prevent execute payrun for selected employee or Camp while executing default payrun.',
    ...
    'working_shift_removed_from_department' => 'Working Shift removed from the Camp.',
    ...
    'department_manager_manage_user_message' => 'The Camp manager cannot be managed from here. Please go to the {department} module and change the manager of a Camp as you need.',
    'has_attendance' => 'Has Attendance',
    'import' => 'Import',
    'export' => 'Export',
    'import_employee' => 'Import Employees',
    'download' => 'Download',
    'download_specific_date' => 'Download Specific Date',
    'download_attendance' => 'Download Attendance',
    'download_absences' => 'Download Absences',
    'clear_correction' => 'Clear corrections',
    ...
    'total_helmets' => 'Total Helmets',
    'total_gate_passes' => 'Total Gate Passes',
    'project_details' => 'Project Details',
    'back_to_all_projects' => 'back to all projects',
    'project_date' => 'Project Date',
    'project' => 'Project',
    'project_id' => 'ID',
    'get_active_helmets' => 'Employees with active helmets only',
    'filter_employees_based_on_helmets' => 'Filter Employees Based on helmet assigment',
    'p_start_date' => 'Start Date',
    'p_end_date' => 'End Date',
    'est_man_hour' => 'EST. Man-Hour',
    'pme_id' => 'PME ID',
    ...
    'valid_to' => 'Valid to',
    'get_valid_gatepassess' =>'Get Valid Gate Passes',
    ...
    'alerts' => 'Alerts',
    'working_shift_name' => 'Working Shift',
    'parent_group' => 'Parent Group',
    'assigned_project'=> 'Assigned',
    'assigned_workishft' => 'Assigned WS',
    'assigned_workishft_details' => 'WS time',
    'transfer_request' => 'Transfer Requests',
    'no_of_comments'=>'No. of comments',
    'enter_approval_note'=> 'Enter Approval Note',
    'confirm_employee_approve'=>'Confirm Approval',
    'orderBy' => 'Order By',
    'Availability'=> 'Availability',
    'you_are_going_to_release_parent_message' => 'are you sure you want to release this project parent?',
    'choose_a_base_time' => 'Choose a base Work time required for this schedule',
    'correct' =>'Correction',
    'bulk_correction'=>'Bulk Correction',
    'clear_project' => 'Clear Assignments',
    'recurring_attendance' => 'Recurring Attendance',
    'by_status' => 'Status By Contract',
    'recurring_artisan_command'=>'System admin should set the following artisan command as a daily cron job : php artisan ra:attendance',

    //projects
    'access_own_projects' => 'can access own projects',
    'access_own_project_employees' => 'can access employees for own projects',
    'access_own_project_coordinator' => 'can access coordinators for own projects',
    'create_projects' =>'can create project',
    'view_projects'=>'can view project',
    'update_projects'=>'can update projects',
    'delete_projects'=>'can delete projects',
    'view_contractors'=>'can view contractors',
    'update_contractors'=>'can update contractors',
    'delete_contractors'=>'can delete contractors',
    'create_contractors'=>'can create contractors',
    'view_locations'=>'can view locations',
    'update_locations'=>'can update locations',
    'delete_locations'=>'can delete locations',
    'create_locations'=>'can create locations',
    'view_subdivisions'=>'can view subdivisions',
    'update_subdivisions'=>'can update subdivisions',
    'delete_subdivisions'=>'can delete subdivisions',
    'create_subdivisions'=>'can create subdivisions'
